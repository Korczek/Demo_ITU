...
namespace Fidgety.CustomAnimation
{
    ...
    public class FidgetyAnim
    {
        ...
        public FidgetyAnim(RunOption runOption, Transform transform, Vector3 targetV3, float animTime,
            AnimController ctrl)
        {
            _tr = transform;
        ...
        public FidgetyAnim(RunOption runOption, Action toRunOnTimeEnd, float animTime, AnimController ctrl)
        {
            _runOption = runOption;
        ...
        public FidgetyAnim Run()
        {
            ...
            {
                Debug.LogWarning(
                    $"Some exception occurred, bot that shouldn't ruin your experience. Keep playing: {ex}");
            }
        ...
        public FidgetyAnim OnStart(Action onStart)
        {
            _onStart = onStart;
            return this;
        }
        ...
        public FidgetyAnim OnComplete(Action onComplete)
        {
        ...
        public FidgetyAnim SetDelay(float delay)
        {
            _delay = delay;
            return this;
        }
        ...
        public FidgetyAnim SetEase(Ease ease)
        {
            _ease = ease;
            return this;
        }
